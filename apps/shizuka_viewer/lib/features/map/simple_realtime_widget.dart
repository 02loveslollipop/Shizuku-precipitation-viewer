/// Simple Real-time Widget for Classic UI
/// 
/// Reads data from GridProvider and displays real-time sensor pins
...
class RealtimeMapWidget extends StatelessWidget {
...
class _RealtimeMap extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final latestTimestamp = _getLatestTimestamp();
      ...
      children: [
        ...
        if (latestTimestamp != null)
          Positioned(
            top: 16,
            left: 16,
            child: _TimestampChip(timestamp: latestTimestamp),
          ),
        Positioned(
          bottom: 12,
          right: 12,
  ...
  DateTime? _getLatestTimestamp() {
    if (measurements.isEmpty) return null;
    return measurements
        .map((m) => m.measurement.ts)
